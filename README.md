...
💡 Please refer to our [documentation](https://docs.scanbot.io/barcode-scanner-sdk/capacitor/supported-barcodes/#data-parsers) for a full list of supported data parsers.
